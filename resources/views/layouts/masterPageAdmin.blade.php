    ...
    <body>
        <header>
          ...
          <ul id="dropdownUsuario" class="dropdown-content">
            <li><a href="{{ url('cambiarContrasena') }}">Cambiar contraseña</a></li>
          ...
          @else
            ...
            <div class="nav-wrapper">
              ...
              <ul class="">
                ...
                <li><a href="{{ url('ActasAdmin') }} ">Actas</a></li>
        ...
        <footer id="footer" class="page-footer">
           <div id="tamanoFooter" class="footer-copyright">
            ...
            <div class="container">
              Copyright © 2017 Diócesis de Alajuela, Costa Rica. Derechos Reservados.
            </div>
          </div>
        </footer>

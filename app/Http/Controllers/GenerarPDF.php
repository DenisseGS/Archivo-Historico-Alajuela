...
class GenerarPDF extends Controller
{
        ...
        public function generarPDF(Request $request){
             ...
             'numAsientoD'=> $request->numAsientoD,'notasMarginalesEdit'=> $request->notasMarginalesEdit, 'numCedulaEdit'=> $request->numCedulaEdit,'tipoHijo'=> $request->tipoHijo,'parroquias' => $parroquias
             ]);
